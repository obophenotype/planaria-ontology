 ...
 * [plana.yml](plana.yml)
     * Determines how your purl.obolibrary.org/obo/plana/ redirects will be handled
     ...
     * Paste in the contents of [plana.yml](plana.yml)
 ...
 * [plana.md](plana.md)
     ...
     * Paste in the contents of [plana.md](plana.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
