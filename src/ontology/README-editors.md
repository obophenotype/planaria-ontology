...
There are two ways to include new classes in an import module
 ...
 2. Add to the imports/plana_terms.txt file
...
Note: the plana_terms.txt file may include 'starter' classes seeded from
...
what is in the `owl:versionIRI` of the derived plana.owl (`data-version` in
plana.obo). This will be today's date.
...
Note: if you have only just created this project you will need to authorize travis for this repo.
 ...
 3. Click the tick symbol next to planaria-ontology
